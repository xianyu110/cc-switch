...
const allGeminiProviderPresets: GeminiProviderPreset[] = [
  ...
  {
    name: "MomoAI",
    websiteUrl: "https://momoai.asia/",
    apiKeyUrl: "https://momoai.asia/",
    settingsConfig: {
      env: {
        GOOGLE_GEMINI_BASE_URL: "https://momoai.asia/v1",
        GEMINI_MODEL: "gpt-5.5",
      },
    },
    baseURL: "https://momoai.asia/v1",
    model: "gpt-5.5",
    description: "MomoAI OpenAI-compatible gateway",
    category: "third_party",
    endpointCandidates: ["https://momoai.asia/v1"],
    icon: "generic",
  },
  {
    name: "自定义",
...
export const geminiProviderPresets = filterVisibleProviderPresets(
