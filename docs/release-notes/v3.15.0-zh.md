...
应用内和 README 中所有"官网"引用都统一到 GitHub Releases 作为唯一官方网站；Release notes 模板也呈现 GitHub Releases。
...
Release notes 模板中呈现 `GitHub Releases`。

### 品牌官网

在各 README 与应用内引用中把 `GitHub Releases` 文档化为唯一官方网站。
