...
### CC Switch ブランド公式サイトを GitHub Releases に統一

アプリ内および README 内のすべての「公式サイト」参照を、唯一の公式サイトとして GitHub Releases に統一しました; Release notes テンプレートにも GitHub Releases を反映。
...
Release notes テンプレート内に `GitHub Releases` を反映しました。

### ブランド公式サイト

各 README およびアプリ内参照で `GitHub Releases` を唯一の公式サイトとしてドキュメント化しました。
