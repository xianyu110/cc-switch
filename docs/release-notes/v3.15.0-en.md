...
### CC Switch brand link cleanup

All in-app and README "official website" references now point at GitHub Releases as the sole official site; the release notes template also surfaces GitHub Releases.
...
The release notes template now surfaces `GitHub Releases`.

### Brand Surface

Documented `GitHub Releases` as the sole official website across READMEs and in-app references.
