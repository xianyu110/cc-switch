...
- **CC Switch brand link cleanup**: Removed the former standalone website from in-app and README references; the release notes template now points to GitHub Releases.
...
- **Release Notes Template**: Surfaces `GitHub Releases` in the release notes template.
- **Brand Surface**: Removed the former standalone website from READMEs and in-app references.
